...
public class DenseDirectedRoutesMap
	implements RoutesMap
{
	protected final int[][] distances;
	
	public DenseDirectedRoutesMap(int numCities)
	{
	...
	{
		DenseDirectedRoutesMap transposed = new DenseDirectedRoutesMap(distances.length);
