...
public class DenseBidirectionalRoutesMap extends DenseDirectedRoutesMap	
{	
	public DenseBidirectionalRoutesMap(int numCities)
	{
		super(numCities);
	}
	...
	public void addDirectRoute(City start, City end, int distance)
	{
		...
		distances[end.getIndex()][start.getIndex()] = distance;
	}
	...
	{
		DenseBidirectionalRoutesMap transposed = new DenseBidirectionalRoutesMap(distances.length);
