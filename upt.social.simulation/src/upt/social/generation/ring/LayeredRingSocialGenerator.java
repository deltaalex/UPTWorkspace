 ...
 */
public class LayeredRingSocialGenerator extends SocialGenerator
{
	public LayeredRingSocialGenerator(ISocialModelFactory modelFactory)
	{
		super(modelFactory);
	}

	/**
	 * Creates a parameterized layered ring network. Contains multiple rings.
	 * 
	 * @param SIZE
	 *        Number of nodes
	 * @param R
	 ...
	 */
	@Override
	public SocialNetwork createNewNetwork(int SIZE, int R, Vector<NodeCoordinate> stubbornAgents,
