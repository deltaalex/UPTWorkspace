...
/**
 * Manages a thread pool for launching tasks that activate agents
 * 
 * @author Alexander
 */
public class TimerLayer extends Thread
{
	...
	/**
	 * A pool thread is used to launch node tasks
	 */
	private ThreadPool threadPool;
	private SocialNetwork network;

	public TimerLayer(SocialNetwork network, int numberOfPoolThreads)
	{
	...
	public void run()
	{
		...
		while (RUNNING)
		{
			...
			time0 = System.nanoTime();
			final Counter counter = new Counter(0, network.getNodes().size());
